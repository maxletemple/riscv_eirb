...
#set_property PACKAGE_PIN F13 [get_ports led_OK]				
...
#set_property PACKAGE_PIN K6 [get_ports led_recommence]					
#set_property IOSTANDARD LVCMOS33 [get_ports led_recommence]
##Bank = 35, Pin name = IO_24P_T3_35,						Sch name =  LED17_G
#set_property PACKAGE_PIN H6 [get_ports led_recommence ]					
#set_property IOSTANDARD LVCMOS33 [get_ports led_recommence ]
...
set_property PACKAGE_PIN E16 [get_ports Scan_Mem]						
set_property IOSTANDARD LVCMOS33 [get_ports Scan_Mem]
##Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
#set_property PACKAGE_PIN F15 [get_ports Bouton_UP]						
#set_property IOSTANDARD LVCMOS33 [get_ports Bouton_UP]
###Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
#set_property PACKAGE_PIN T16 [get_ports Bouton_LEFT]						
#set_property IOSTANDARD LVCMOS33 [get_ports Bouton_LEFT]
###Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
#set_property PACKAGE_PIN R10 [get_ports Bouton_RIGHT]						
#set_property IOSTANDARD LVCMOS33 [get_ports Bouton_RIGHT]
###Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
#set_property PACKAGE_PIN V10 [get_ports Bouton_DOWN]						
#set_property IOSTANDARD LVCMOS33 [get_ports Bouton_DOWN]
